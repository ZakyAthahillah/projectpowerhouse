...
<body>
    ...
    <div class="container">
        <div class="form-group">
            <div class="form-line">
                <h6 class="m-0 font-weight-bold text-primary">PRINT LAPORAN BARANG MASUK BERDASARKAN BULAN DAN TAHUN<a href="http://localhost/projectpowerhouse/index/index_admin.php?page=laporan_barangmasuk" class="btn btn-success float-right"><i class="fas fa-arrow-left"> Kembali</i></a></h6></h6>
            </div>
        </div>
