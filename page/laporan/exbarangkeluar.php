...
if (isset($_POST['submit'])) {
    ...
    $pdf->SetTitle('Laporan Barang Keluar Bulan ' . $bulan . ' Tahun ' . $tahun);
    $pdf->AddPage();
    ...
    $pdf->Cell(282, 7, 'LAPORAN BARANG KELUAR', 1, 1, 'C', true);
    $pdf->Ln(2);
    ...
    $pdf->Output('Laporan Barang Keluar Bulan ' . $bulan . ' Tahun ' . $tahun . '.pdf', 'I');
}
...
<body>
    ...
    <div class="container">
        <div class="form-group">
            <div class="form-line">
                <h6 class="m-0 font-weight-bold text-primary">PRINT LAPORAN BARANG KELUAR BERDASARKAN BULAN DAN TAHUN<a href="../../index/index_admin.php?page=laporan_barangkeluar" class="btn btn-success float-right"><i class="fas fa-arrow-left"> Kembali</i></a></h6>
                </h6>
            </div>
        </div>
