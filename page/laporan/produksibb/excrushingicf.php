...
if (isset($_POST['submit'])) {
    ...
    $pdf->Cell(0, 7, 'LAPORAN CRUSHING ICF', 0, 1, 'C');
...
<body>
    ...
    <div class="container">
        <div class="form-group">
            <div class="form-line">
                <h6 class="m-0 font-weight-bold text-primary">PRINT LAPORAN CRUSHING ICF BERDASARKAN BULAN DAN TAHUN<a href="../../../index/index_admin.php?page=laporan_crushingicf" class="btn btn-success float-right"><i class="fas fa-arrow-left"> Kembali</i></a></h6>
                </h6>
            </div>
        </div>
