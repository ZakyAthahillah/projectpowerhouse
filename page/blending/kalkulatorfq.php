                ...
                <div class="body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="list-group">
                            ...
                            <p class="list-group-item list-group-item-action font-weight-bold"><button type="button" class="btn btn-warning"></button> Yellow Crushed : <?= $yellowResult ?> TON</p>
                            <p class="list-group-item list-group-item-action font-weight-bold"><button type="button" class="btn btn-success"></button> Green Crushed : <?= $greenResult ?> TON</p>
                            <p class="list-group-item list-group-item-action font-weight-bold"><button type="button" class="btn btn-primary"></button> Blue Crushed : <?= $blueResult ?> TON</p>
                        </div>
                    </form>
                </div>
            </div>
