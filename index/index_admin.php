  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav  bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseStockcoaljty" class="collapse" aria-labelledby="headingStockcoaljty" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header text-dark">Menu:</h6>
            <a class="collapse-item" href="?page=stokcoaljty">Stock Coal Jetty</a>
          </div>
        </div>
      </li>

      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseStockcoalicf" aria-expanded="true" aria-controls="collapseStockcoalicf">
          <i class="fas fa-fw fa-folder"></i>
          <span>STOCK COAL ICF</span>
        </a>
        <div id="collapseStockcoalicf" class="collapse" aria-labelledby="headingStockcoalicf" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header text-dark">Menu:</h6>
            <a class="collapse-item" href="?page=stokcoalicf">Stock Coal ICF</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLoading" aria-expanded="true" aria-controls="collapseLoading">
          <i class="fas fa-fw fa-folder"></i>
          <span>LOADING</span>
        </a>
